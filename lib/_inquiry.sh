...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu PLW Design que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  printf "\n\n"
  printf "   [0] Instalar PLW Design\n"
  printf "   [1] Atualizar PLW Design\n"
  printf "   [2] Deletar PLW Design\n"
  printf "   [3] Bloquear PLW Design\n"
  printf "   [4] Desbloquear PLW Design\n"
  printf "   [5] Alter. dominio PLW Design\n"
  printf "\n"
  read -p "> " option
